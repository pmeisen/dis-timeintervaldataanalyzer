...
/**
 * Exception thrown whenever a problem with {@code MetaDataModel} occurs.
 * 
 * @author pmeisen
 * 
 */
public class MetaDataModelException extends RuntimeException {
	 ...
	 */
	public MetaDataModelException(final String message) {
		super(message);
	}
	 ...
	 */
	public MetaDataModelException(final String message, final Throwable t) {
		super(message, t);
	}
}
