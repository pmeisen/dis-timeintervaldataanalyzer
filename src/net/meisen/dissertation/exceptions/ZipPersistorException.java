 ...
 * 
 */
public class ZipPersistorException extends RuntimeException {
	 ...
	 */
	public ZipPersistorException(final String message) {
		super(message);
	}
	 ...
	 */
	public ZipPersistorException(final String message, final Throwable t) {
		super(message, t);
	}
}
