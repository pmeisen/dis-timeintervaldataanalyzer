...
/**
 * Exception thrown whenever a problem with {@code IntervalModel} occurs.
 * 
 * @author pmeisen
 * 
 */
public class IntervalModelException extends RuntimeException {
	 ...
	 */
	public IntervalModelException(final String message) {
		super(message);
	}
	 ...
	 */
	public IntervalModelException(final String message, final Throwable t) {
		super(message, t);
	}
}
