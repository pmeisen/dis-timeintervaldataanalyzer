 ...
 * 
 */
public class MapDbBitmapIdCacheException extends RuntimeException {
	 ...
	 */
	public MapDbBitmapIdCacheException(final String message) {
		super(message);
	}
	 ...
	 */
	public MapDbBitmapIdCacheException(final String message, final Throwable t) {
		super(message, t);
	}
}
