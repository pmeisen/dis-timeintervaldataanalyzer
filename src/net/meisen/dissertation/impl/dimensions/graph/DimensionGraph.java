...
public class DimensionGraph {
	...
	/**
	 * Gets all the nodes of the {@code DimensionGraph}.
	 * 
	 * @return all the nodes of the {@code DimensionGraph}
	 */
	...
	/**
	 * Gets all the levels of the {@code DimensionGraph}.
	 * 
	 * @return all the levels of the {@code DimensionGraph}
	 */
	...
	/**
	 * Gets the one and only sink, a.k.a. root, of the graph.
	 * 
	 * @return the one and only sink, a.k.a. root, of the graph
	 */
	public Node getSink() {
	...
	/**
	 * Creates the graph based on the specified {@code DescriptorDimension}.
	 * 
	 * @param dimension
	 ...
	 */
	public void create(final DescriptorDimension dimension)
			throws ForwardedRuntimeException {
		this.validated = false;
		...
		final Collection<DescriptorHierarchy> hierarchies = dimension
				.getHierarchies();
