...
public class TidaModel implements IPersistable {
     ...
     *
     * @param id the identifier used for the {@code MetaDataModel}
     */
     ...
     *
     * @param id   the identifier used for the {@code MetaDataModel}
     * @param name the name of the {@code MetaDataModel}, if {@code null} the
     ...
     * @param name     the name of the {@code MetaDataModel}, if {@code null} the
     *                 name will be equal to the {@code id}
     * @param location the working directory of the model
     */
     ...
     *
     * @param deleteLocation {@code true} if all folders should be deleted, which were
     ...
     *
     * @param record the {@code DataRecord} to be loaded
     */
     ...
     * Loads the specified record into the database.
     *
     * @param dataStructure the {@code DataStructure} to be used for the data
     * @param record        the {@code DataRecord} to be loaded
     */
    ...
    protected int _loadRecord(final DataStructure dataStructure,
		...
		/*
		 * Now index the record, if an error occurs the used id will never be
		 * marked as valid.
		 */
     ...
     *
     * @param it the {@code iterator} for the data to be loaded
     ...
     * thrown.
     *
     * @param enable {@code true} to enable bulk-load, or {@code false} to disable
     * @throws TidaModelException if bulk-loading should be enabled, while already being
     *                            enabled
     */
     ...
     *
     * @param ids the list of {@code ids} to be invalidated
     ...
     * @param dataStructure       the {@code DataStructure} to be used for the data
     * @param it                  the {@code iterator} for the data to be loaded
     * @param retrieveIdentifiers {@code true} if the returned array should contain all the
    ...
    protected int[] bulkLoadData(final DataStructure dataStructure,
        ...
        // make sure the model is initialized
        if (!isInitialized()) {
            exceptionRegistry.throwException(TidaModelException.class, 1001, "loadData");
        }
     ...
     *
     * @param metaDataHandling the handling of the meta-data
     * @see MetaDataHandling
     */
     ...
     * handled.
     *
     * @param mode the {@code OfflineMode} to be used
     ...
     * found.
     *
     * @param handling the handling of the interval-data
     * @see IntervalDataHandling
     */
