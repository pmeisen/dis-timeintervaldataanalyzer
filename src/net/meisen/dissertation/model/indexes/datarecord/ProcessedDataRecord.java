...
public class ProcessedDataRecord {
     ...
     *
     * @param raw   the {@code DataRecord} to be processed
     * @param model the {@code Model} which defines how to process the record
     ...
     * {@code TidaModel} and the {@code DataRecord}.
     *
     * @param dataStructure overrides the {@code DataStructure} of the specified
     *                      {@code model}
     * @param raw           the {@code DataRecord} to be processed
     * @param model         the {@code Model} which defines how to process the record
     * @param id            the identifier of the record
    ...
    public ProcessedDataRecord(final DataStructure dataStructure,
        ...
        this.processedMeta = new HashMap<>();

        // handle the IntervalStructureEntries
        final List<IntervalStructureEntry> intervalEntries = dataStructure.getEntriesByClass(IntervalStructureEntry.class);
        ...
        final List<MetaStructureEntry> metaEntries = dataStructure.getEntriesByClass(MetaStructureEntry.class);
     ...
     *
     * @param entry the {@code MetaStructureEntry} to get the {@code Descriptor}
     *              for
     ...
     *
     * @param model the {@code DescriptorModel} to get the {@code Descriptor} for
     ...
     *
     * @param modelId the identifier of the {@code DescriptorModel} to get the
     *                {@code Descriptor} for
     * @return the {@code Descriptor} for the specified {@code model}
     */
     ...
     *
     * @param entry the entry to get the mapped, normalized value for
     ...
     *
     * @param metaEntry the {@code MetaStructureEntry} to determine the
     *                  {@code Descriptor} for
     * @param model     the {@code TidaModel}
     */
     ...
     *
     * @param startEntry the {@code IntervalStructureEntry} used for the start
     * @param endEntry   the {@code IntervalStructureEntry} used for the end
     * @param model      the {@code TidaModel}
     */
     ...
     * 0-based.
     *
     * @param meta   the {@code DataRecordMeta} used to create the object-array
     * @param mapper the {@code BaseMapper} used to resolve the start and end
