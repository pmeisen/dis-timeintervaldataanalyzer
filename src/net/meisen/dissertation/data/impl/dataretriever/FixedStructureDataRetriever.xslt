...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="fxd:record">
    <bean class="net.meisen.dissertation.data.impl.dataretriever.FixedStructureDataRetrieverConfig">
      <constructor-arg type="java.util.Collection">
      
        <list value-type="net.meisen.dissertation.data.impl.dataretriever.FixedStructureDataRetrieverConfigEntry">
          <xsl:for-each select="fxd:field">
            <xsl:variable name="type" select="@type" />
            
            <bean class="net.meisen.dissertation.data.impl.dataretriever.FixedStructureDataRetrieverConfigEntry">  
  ...
  <xsl:template match="fxd:query">
    <bean class="net.meisen.dissertation.data.impl.dataretriever.FixedStructureQueryConfig">
