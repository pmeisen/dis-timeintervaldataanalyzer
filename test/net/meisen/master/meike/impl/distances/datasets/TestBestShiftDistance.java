...
public class TestBestShiftDistance {
    private final Dataset original = new Dataset(ImmutableSet.of(
            new Interval(0L, 4L),
            new Interval(2L, 7L),
            new Interval(9L, 12L),
            new Interval(5L, 50L),
            new Interval(10L, 12L)));
    private final Dataset shiftedByThree = new Dataset(ImmutableSet.of(
            new Interval(3L, 7L),
            new Interval(5L, 10L),
    ...
    public void testThatShiftedIntervalGivesZeroDistance() {
        final IDatasetMinCostMatcher matcher = this.createKuhnMunkresMatcher();
