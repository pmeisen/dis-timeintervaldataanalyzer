...
public class TestTidaServer {
     ...
     *
     * @throws IOException if the socket cannot be handled
     */
    @Test
     ...
     * down.
     *
     * @throws IOException if an unexpected exception while writing or reading is thrown
     */
    @Test
    public void testCloseSocketAfterShutdown() throws IOException {
        ...
        assertTrue(exception.getMessage(),
                exception.getMessage().contains("Broken pipe") ||
                        ...
                        exception.getMessage().contains("caused connection abort"));
     ...
     *
     * @throws IOException if the shutdown cannot be achieved
     */
    @After
