...
@SystemProperty(property = "performanceBeans.selector", value = "net/meisen/dissertation/performance/indexes/nestedIndexedCollectionBeans.xml")
public class TestNestedIndexedCollectionPerformance {
	 ...
	 * 
	 */
	public static class DataGenerator implements IDataGenerator {
		...
		public Object generateData() {
			i++;
			return new PersonMock("Musterman", "Max", i);
		}
	}
