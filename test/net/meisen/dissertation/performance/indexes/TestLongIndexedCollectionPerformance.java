...
@SystemProperty(property = "performanceBeans.selector", value = "net/meisen/dissertation/performance/indexes/longIndexedCollectionBeans.xml")
public class TestLongIndexedCollectionPerformance {
	...
	/**
	 * Generator which creates a long for the specified data.
	 * 
	 * @author pmeisen
	 * 
	 */
	public static class LongIdGenerator implements IIdGenerator {
	 ...
	 * 
	 */
	public static class LongDataGenerator implements IDataGenerator {
