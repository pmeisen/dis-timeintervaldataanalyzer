...
public class TestIndexedCollectionDefinition {
    ...
    public void testExceptionWhenNoType() {
        ...
        thrown.expectMessage(CoreMatchers.containsString("type must be specified"));
    ...
    public void testExceptionWhenToManyTypesAreDefined() {
        ...
        thrown.expectMessage(CoreMatchers.containsString("cannot be more types ('3') specified than arguments ('2')"));
    ...
    public void testExceptionWhenInvalidTypesAreDefined() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("type at position '1' must be '"
    ...
    public void testExceptionWhenNoConstructorCanBeFound() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("Cannot find any valid constructor for the definition"));
