...
public class TestRhinoScriptPreProcessor extends LoaderBasedTest {
    ...
    public void testUsageInModel() {
        final TidaModel model = m("/net/meisen/dissertation/impl/dataintegration/testRhinoScriptModel.xml", true);
    ...
    protected ScriptPreProcessor create(final String script) {
        ...
        final ScriptPreProcessorConfig config = new ScriptPreProcessorConfig("rhino");
