...
public class TestIndexKeyDefinition {
    ...
    public void testValueRetrieval() {
        ...
        // create a descriptor
        final DescriptorModel<Integer> model =
                new DescriptorModel<>("MYID", IntegerDescriptor.class, new IntegerIdsFactory());
        final IntegerDescriptor<Integer> descriptor = new IntegerDescriptor<>(model, 1, 5000);
    ...
    public void testPrimitiveTypes() {
        ...
        assertEquals(5, keyInteger.getValues(5)[0]);
    }
    ...
    public void testGetValue() {
        final IndexKeyDefinition key1 = new IndexKeyDefinition(Integer.class,
                "intValue");
        assertEquals(key1.getValue(5, Integer.class), new Integer(
                5));

        final IndexKeyDefinition key2 = new IndexKeyDefinition(Integer.class);
        assertEquals(key2.getValue(15, Integer.class),
                new Integer(15));
    ...
    public void testGenerateKeyFromValues() {
        final IndexKeyDefinition key1 = new IndexKeyDefinition(Integer.class,
                "intValue");
        assertEquals(key1.getKey(5), key1.generateKeyFromValues(5));
    ...
    public void testGenerateTypedKeyFromValues() {
        ...
        assertEquals(new Long(5),
                key4.generateTypedKeyFromValue(5L, Long.class));
    }
    ...
    public void testMatches() {
        ...
        assertTrue(keyDef.matches(null, null));
        assertTrue(keyDef.matches("HelloWorld", TestIndexKeyDefinition.class));
        assertFalse(keyDef.matches(null, 5));
        assertFalse(keyDef.matches(5));
        ...
        assertFalse(keyDef.matches(null, null));
    }
    ...
    public void testInvalidMethodNullConstrcution2() {
        ...
        thrown.expectMessage(CoreMatchers.containsString("getterMethods cannot be null"));
    ...
    public void testInvalidMethodWithNullConstrcution() {
        ...
        thrown.expectMessage(CoreMatchers.containsString("method 'null' cannot be accessed or found"));
    ...
    public void testInvalidMethodNameConstrcution() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("method 'getValue3' cannot be accessed or found"));
    ...
    public void testInvalidNullValueRetrieval() {
        thrown.expect(NullPointerException.class);
        thrown.expectMessage(CoreMatchers.containsString("object cannot be null"));
    ...
    public void testInvalidValueRetrieval() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("passed object '"
     ...
     */
    @Test
    public void testInvalidVoidMethodConstruction() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("method 'testInvalidVoidMethodConstruction' doesn't return any value"));

        new IndexKeyDefinition(TestIndexKeyDefinition.class, "testInvalidVoidMethodConstruction");
    }
    ...
    public void testInvalidGetValueFromComposite() {
        ...
        thrown.expectMessage(CoreMatchers.containsString("within an IndexKeyDefinition with multiple keys"));

        final IndexKeyDefinition key = new IndexKeyDefinition(Integer.class,
                "intValue", "getClass");
        key.getValue(5, Integer.class);
    }
    ...
    public void testInvalidGetValueExpectationWithMethod() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("which is assignable from '"
                + Long.class.getName() + "' but got '5' ('"
                + Integer.class.getName() + "')"));

        final IndexKeyDefinition key = new IndexKeyDefinition(Integer.class,
                "intValue");
        key.getValue(5, Long.class);
    }
    ...
    public void testInvalidGetValueExpectationWithObject() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("Expected an object which is assignable from '"
                + Long.class.getName() + "' but got '5' ('"
                + Integer.class.getName() + "')"));
    ...
    public void testInvalidGetValueExceptionObjectClass() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("expected class '"
                + Long.class.getName()
    ...
    public void testInvalidGenerateTypedKeyFromValueWrongObjectClass() {
        ...
        final IndexKeyDefinition key = new IndexKeyDefinition(String.class);
        key.generateTypedKeyFromValue(5L, Long.class);
    }
    ...
    public void testInvalidGenerateTypedKeyFromValueWrongMethod() {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage(CoreMatchers.containsString("expected '"
                + Long.class.getName()
